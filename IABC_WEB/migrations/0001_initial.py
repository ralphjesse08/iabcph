# Generated by Django 4.0 on 2022-08-12 02:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='IABC_WEB.members', verbose_name='membership_id')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='members.user', verbose_name='user_id')),
            ],
        ),
        migrations.CreateModel(
