# Generated by Django 4.0 on 2022-08-10 07:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entrant_name', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant name'))),
                ('mobile_num', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Mobile number'))),
                ('email_add', models.CharField(max_length=100, unique=True, verbose_name='Email')),
                ('entrant_org', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant Organization'))),
                ('client_org', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Client Organization'))),
                ('entrant_title', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant Title'))),
                ('entry_title', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entry title'))),
                ('if_member', models.BooleanField(default=False)),
                ('entrant_membershipnum', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant Membership No.'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('entrant_name', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant name'))),
                ('mobile_num', django_cryptography.fields.encrypt(models.CharField(max_length=20, verbose_name='Mobile number'))),
                ('email_add', models.CharField(max_length=200, unique=True, verbose_name='Email')),
                ('entrant_school', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant school'))),
                ('entrant_degree', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Entrant degree'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priceVal', django_cryptography.fields.encrypt(models.CharField(max_length=50, verbose_name='Value'))),
            ],
        ),
        migrations.CreateModel(
            name='Winners',
            fields=[
                ...
                ('entryName', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Entry Name'))),
                ...
                ('entrantName', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Entrant Name'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('event_name', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Event Name'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('act_Task', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Activity Task'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_name', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Company Name'))),
                ('floor_no', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Floor No'))),
                ('building_no', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Building No'))),
                ('street', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Street'))),
                ('baranggay', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Baranggay'))),
                ('city', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='City'))),
                ('region', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Region'))),
                ('postal_zip', django_cryptography.fields.encrypt(models.CharField(max_length=4, verbose_name='Postal Zip'))),
                ('telephone_no', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Telephone No'))),
                ('fax_no', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Fax No'))),
                ('mobile_no', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Mobile No'))),
                ('email_address', models.CharField(max_length=200, verbose_name='Email')),
                ('birthday', django_cryptography.fields.encrypt(models.CharField(max_length=200, verbose_name='Birthday'))),
                ...
                ('profile_photo', django_cryptography.fields.encrypt(models.FileField(blank=True, null=True, upload_to='MembersSubmissions/'))),
                ('expiry_date', models.CharField(blank=True, max_length=100, null=True, verbose_name='Expiry Date')),
                ('is_paid', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cperson', django_cryptography.fields.encrypt(models.CharField(max_length=100, verbose_name='Contact Person'))),
                ('cnum', django_cryptography.fields.encrypt(models.CharField(max_length=50, verbose_name='Contact Number'))),
                ('address', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Address'))),
                ('awards_profid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='IABC_WEB.awards_prof', verbose_name='awards_profid')),
                ('awards_studentid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='IABC_WEB.awards_student', verbose_name='awards_studentid')),
                ('membership_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='IABC_WEB.members', unique=True, verbose_name='membership_id')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='members.user', verbose_name='user_id')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checks', django_cryptography.fields.encrypt(models.CharField(max_length=255, verbose_name='Checks'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.CharField(max_length=255, verbose_name='Comments')),
                ('commDate', models.DateTimeField(max_length=255, verbose_name='Comment Date')),
                ('bid_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='IABC_WEB.biddersubmission', verbose_name='bid_id')),
            ],
        ),
        migrations.AddField(
